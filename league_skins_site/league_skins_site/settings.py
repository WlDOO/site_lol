"""
Django settings for league_skins_site project.
...
SECRET_KEY = 'django-insecure-rz-@oc)+dv-q!&v!c_!en9j$_15@$+!f^lsbndh0ioz-%se7%k'
...
ROOT_URLCONF = 'league_skins_site.urls'
...
WSGI_APPLICATION = 'league_skins_site.wsgi.application'
